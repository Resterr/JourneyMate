	...
	return (
		<div className="searchPlace__types">
			<FormControl className="searchPlace__types-form">
				<InputLabel style={{ color: '#00AAFF' }} className="searchPlace__types-form-label">Tags</InputLabel>
				<Select style={{ color: '#00AAFF' }} className="searchPlace__types-form-select"
				...
				>
					{types.map((x) => (
						<MenuItem key={x.name} value={x.name}>
							<Checkbox checked={selectedTypes.indexOf(x.name) > -1} />
