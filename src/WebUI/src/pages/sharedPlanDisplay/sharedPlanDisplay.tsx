...
const SharedPlanDisplay: React.FC = () => {
  const { id } = useParams();
  ...
  useEffect(() => {
    ...
    axiosInstance
      .get<PaginatedPlaces>(
        `/api/plan/shared/${id}/places?PageNumber=${pageNumber}&PageSize=${pageSize}${
...
export default SharedPlanDisplay;
