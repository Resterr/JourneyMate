		...
		await axiosInstance
			...
			.then((response) => {
				if (response.status === 200) {
					...
					const formLogin = document.getElementById("form-login") as HTMLInputElement;
					const formPassword = document.getElementById("form-password") as HTMLInputElement;
					const formPasswordConfirm = document.getElementById("form-password-confirm",) as HTMLInputElement;
