...
type UserContextType = {
	...
	setTokens : (accessToken : string | null, refreshToken : string | null, refreshTokenExpireDate : string | null) => void;
...
export const UserProvider : React.FC<{ children : React.ReactNode }> = ({children}) => {
	...
	const setTokens = (newAccessToken : string | null, newRefreshToken : string | null, newRefreshTokenExpireDate : string | null) => {
		...
		if (newAccessToken !== null && newRefreshToken !== null && newRefreshTokenExpireDate !== null) {
	...
	return (
		<UserContext.Provider value={
			{accessToken, refreshToken, refreshTokenExpireDate, currentUser, setTokens, updateTokens, setUserName, logout}}>
			{children}
